...
public class OObjectDatabaseTx extends ODatabasePojoAbstract<Object> implements ODatabaseObject, OUserObject2RecordHandler {
   ...
   * entity classes.
   * 
   * @see com.orientechnologies.orient.core.entity.OEntityManager#registerEntityClasses(String)
   */
   ...
   * a detached non proxied instance @see {@link com.orientechnologies.orient.object.enhancement.OObjectEntitySerializer.detach(T o, com.orientechnologies.orient.core.db.object.ODatabaseObject db, boolean
   ...
   * 
   * @see com.orientechnologies.orient.core.record.ORecordSchemaAware#validate()
   */
