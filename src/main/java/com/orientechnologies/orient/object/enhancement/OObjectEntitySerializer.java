...
public class OObjectEntitySerializer {
   ...
   * {@link com.orientechnologies.orient.object.enhancement.OObjectEntitySerializer#detach(T o, com.orientechnologies.orient.core.db.object.ODatabaseObject db, boolean returnNonProxiedInstance)}
   * 
   * @param <T>
   * @param o
